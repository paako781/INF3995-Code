...
public:
   ...
   /*
    * This function initilizes socket connection
    */
   virtual void InitializesSockets();
   //virtual void InitializesSockets(int droneNb);

   /*
    * This function listen for connection on the socket
    */
   virtual void listenForConnection();

   /// random walk

   /*
    * This function move the drone to the specifies position
    */
   void MoveTo(CVector3 trans);

   /*
    * This function return a CVector3 position with a random dx and dy between -1 and 1
    */
   ...
   /*
    * This function return the drone's number
    */
   
   int GetDroneNumber();
   
   void SendInformations(std::string message);

   void ReadInformation();

   void ReturnToBase(CVector3 cPos);
...
private:  
   ...
   int FdServers_pre[MAX_DRONE_NO];
   int FdServers[MAX_DRONE_NO];
